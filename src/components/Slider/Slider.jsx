...
class Slider extends React.Component {
  ...
  createNavArrows() {
    ...
    this.leftArrow = (
      <button
        ...
        className="slider-arrows__item slider-arrows__item--left"
      >
    ...
    this.rightArrow = (
      <button
        type="button"
        onClick={() => this.changeSlide(currentSlide + 1)}
        className="slider-arrows__item slider-arrows__item--right"
      >
        <Svg width="15px" height="15px" viewBox="0 0 285 285" fill="#fff">
          <g>
            <path
  ...
  render() {
    ...
    if (navArrows) this.createNavArrows();
    const { leftArrow, rightArrow } = this;

    const classes = classnames('slider', { [className]: className });
    ...
    return (
      <div className={classes}>
        ...
        />
        {navArrows && <div className="slider-arrows">{[leftArrow, rightArrow]}</div>}
      </div>
    );
  }
}
